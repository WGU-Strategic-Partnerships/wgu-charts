...
function WguChart(props) {
  ...
  useEffect(() => {
    ...
    handleRef.current = getApi().mount(elRef.current, {
      ...
      labels,
      opts,
      onClick: (h) => cbRef.current.onClick?.(h),
      onDrill: (h) => cbRef.current.onDrill?.(h)
    });
    return () => {
  ...
  return isRenderModelType(type) ? /* @__PURE__ */ jsx("div", { ref: elRef, className, style }) : /* @__PURE__ */ jsx("canvas", { ref: elRef, className, style });
}
export {
  WguChart
};
