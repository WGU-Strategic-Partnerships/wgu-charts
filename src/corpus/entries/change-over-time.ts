...
export const changeOverTime: CorpusEntry[] = [
...

  {
    ...
    sampleData: [
      { date: 'Jan 1', o: 150, h: 162, l: 148, c: 158, vol: 12000 },
      ...
      option: {
        ...
        series: [
          ...
          },
          {
            ...
            xAxisIndex: 1,
            yAxisIndex: 1,
            data: [12000, 8500, 9800, 14200, 10600],
            itemStyle: { color: '#0070F0', borderRadius: [4,4,0,0] },
          },
        ],
      },
...

  {
    ...
    sampleData: {
      ...
      series: [
        { label: 'Business', data: [3800, 4100, 4400, 4700, 5000] },
        { label: 'Technology', data: [2900, 3200, 3600, 4000, 4400] },
