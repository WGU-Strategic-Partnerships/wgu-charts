...
export const correlation: CorpusEntry[] = [
  ...
  },
  {
    ...
    description: 'Points are time-ordered and connected sequentially with a line, revealing the trajectory through bivariate space. Useful for showing year-over-year shifts in enrollment vs. completion rate per program.',
