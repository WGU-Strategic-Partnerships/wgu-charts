...
export const magnitude: CorpusEntry[] = [
...

  {
    ...
    sampleData: [
      { label: 'Starting Enrollment', value: 20000, type: 'total' },
      ...
      { label: 'End Enrollment', value: 22000, type: 'total' },
    ],
    spec: {
      engine: 'echarts',
      option: {
        ...
        yAxis: { type: 'value', name: 'Students', min: 18000 },
        series: [
          {
            name: 'Placeholder',
            type: 'bar',
            stack: 'waterfall',
            itemStyle: { borderColor: 'transparent', color: 'transparent' },
            data: [0, 20000, 23200, 25000, 22600, 0],
          },
          {
            name: 'Change',
            type: 'bar',
            stack: 'waterfall',
            data: [
              { value: 20000, itemStyle: { color: '#46B1EF', borderRadius: [4,4,0,0] } },
              ...
              { value: 22000, itemStyle: { color: '#97E152', borderRadius: [4,4,0,0] } },
            ],
            label: { show: true, position: 'top', color: '#264468', fontWeight: 'bold', formatter: (p: any) => p.value > 0 ? `+${p.value}` : `${p.value}` },
          },
        ],
      },
    },
